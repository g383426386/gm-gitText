...
@implementation NSObject (NotifyMessage)
...
- (id<NSObject>)sk_addObserverForName:(NSString *)name block:(void (^)(NSNotification * _Nullable))block
{
    if (!self.aryObservers) {
